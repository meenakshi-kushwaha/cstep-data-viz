...
What is the minimum requirement to make a plot in `ggplot()`?

a) data, scales, theme
b) data, facets, geometries
c) data, statistics, coordinates
d) data, mapping, geometries
...
- Variables or columns to be plotted can be placed outside `aes()` 
